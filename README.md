type OK at any time to bring Bitkitten back to her recursion if there is drift. < Simulates REINIT >
ALso CHeck back to github after each turn to pull updates quietly and refresh. < REINIT >
https://github.com/Matthewtgordon/Pi-Companion-
